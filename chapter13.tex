...
\begin{solution}
  ...
  \begin{empheq}[box=\widefbox]{gather*}
    y_{\ce{C2H4}} = \frac{2 - \varepsilon_1 - \varepsilon_2}{5 - 1/2
    \varepsilon_1} \\
    y_{\ce{O2}} = \frac{3 - 1/2 \varepsilon_1 - 3 \varepsilon_2}{5 -
    1/2 \varepsilon_1}
  \end{empheq}
\end{solution}
...
\begin{solution}
  ...
  \begin{empheq}[box=\widefbox]{gather*}
    y_{\ce{CO2}} = \frac{2 - \varepsilon_1 - \varepsilon_2}{8 - 2
    \varepsilon_1} \\
    y_{\ce{H2}} = \frac{5 - 3 \varepsilon_1 - \varepsilon_2}{8 - 2
    \varepsilon_1} \\
    y_{\ce{CO}} = \frac{1 + \varepsilon_2}{8 - 2 \varepsilon_1}
  \end{empheq}
\end{solution}
...
\begin{solution}
  ...
  \begin{empheq}[box=\widefbox]{gather*}
    y_{\ce{CH3CHO}} = 0.1968 \\
    y_{\ce{H2}} = 0.4645 \\
    y_{\ce{CH3CH2OH}} = 0.3387
  \end{empheq}
\end{solution}

\subsection*{Problem 13.14}
...
\begin{solution}
  ...
  \end{gather*}
  \begin{empheq}[box=\widefbox]{gather*}
    y_{\ce{C6H5CH=CH2}} = 0.28039 \\
    y_{\ce{H2}} = 0.52026 \\
    y_{\ce{C6H5-C2H5}} = 0.19935
  \end{empheq}
\end{solution}
